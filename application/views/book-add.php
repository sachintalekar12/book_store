...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <div class="main">
    <?php echo form_open_multipart('books/add_books')  ?>
        <div class="form-group">
          <label for="bookName">Book Name</label>
          <?php echo form_input(['name'=> 'book_name','value'=>  set_value('book_name'),'class'=> 'form-control','id'=> 'bookName','placeholder'=> 'Enter Book Name']) ?>
          <?php  echo form_error('book_name', '<div class="text-danger">','</div>') ?>
        </div>
        <div class="form-group">
          <label for="authorEmail">Author Email</label>
          <?php echo form_input(['name'=> 'author_email','value'=>  set_value('author_email'), 'class'=> 'form-control', 'id'=> 'authorEmail', 'placeholder'=> 'Enter Author Email'])  ?>
        ...
        <div class="form-group">
          ...
          <?php echo form_input(['name'=> 'website','value'=>  set_value('website'), 'class'=> 'form-control', 'id'=> 'website', 'placeholder'=> ' Enter Website']) ?>
          </div>
        ...
        <div class="form-group">
          ...
          <?php  echo form_input(['name'=>'date', 'id'=> 'datepicker', 'value'=>  set_value('date'), 'width'=> '100%']) ?>
        ...
        <div class="form-row">
          <div class="col">
            <div class="form-group">
              ...
              <?php echo form_input(['name'=> 'isbn','class'=> 'form-control','value'=>  set_value('isbn'), 'id'=> 'website', 'placeholder'=> 'Enter ISBN Number']) ?>
          ...
          <div class="col">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <?php echo form_input(['name'=>'price','value'=>  set_value('price'),'class'=> 'form-control','aria-label'=> 'Amount (to the nearest dollar)'])  ?>
              </div>
        ...
        <div class="form-group ">
          ...
          <div class="custom-control custom-checkbox">
            <?php echo form_checkbox(['name'=> 'paperback','value'=>'1','class'=> 'custom-control-input','id'=> 'customCheck1']) ?>
            <label class="custom-control-label" for="customCheck1">Paperback</label>
          </div>
          <div class="custom-control custom-checkbox">
            <?php echo form_checkbox(['name'=> 'hardback','value'=>'1','class'=> 'custom-control-input','id'=> 'customCheck2']) ?>
            <label class="custom-control-label" for="customCheck2">Hardback</label>
          </div>
          <div class="custom-control custom-checkbox">
            <?php echo form_checkbox(['name'=> 'ebook','value'=>'1','class'=> 'custom-control-input','id'=> 'customCheck3']) ?>
        ...
        <div class="form-group ">
          ...
          <?php echo form_checkbox(['name'=> 'stock', 'value'=>'1','checked'=>'checked', 'data-toggle'=> 'toggle', 'data-on'=> 'Available','data-off'=>'Out Of Stock','data-onstyle'=> 'success','data-offstyle'=> 'danger', 'data-height'=>'30']) ?>
        </div>
        <div class="form-group">
          ...
          <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="customRadioInline3" name="customRadioInline1" value="3" class="custom-control-input">
            <label class="custom-control-label" for="customRadioInline3">3</labl>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="customRadioInline4" name="customRadioInline1" value="4" class="custom-control-input">
            <label class="custom-control-label" for="customRadioInline4">4</labl>
          </div>
          <div class="custom-control custom-radio custom-control-inline">
            <input type="radio" id="customRadioInline5" name="customRadioInline1" value="5" class="custom-control-input">
        ...
        <div class="form-group">
          ...
          <?php echo form_textarea(['name'=> 'review', 'value'=>  set_value('review'),'class'=> 'form-control', 'rows'=> '5', 'id'=>'comment']) ?>
